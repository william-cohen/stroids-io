...
const CONNECTION = "127.0.0.1:3001"; //process.env.SERVER_URL;
...
class Game {
    constructor(username) {
        ...
        function setup() {
            ...
            ui = new UIOverlay(CANVAS_WIDTH, username, IsMobile());
            ui.insertInto(gui);
            ...
            socket.on('state', function(state) {
                ...
                if (player.alive) {
                    if (leaderID === player.id) {
                        ...
                        if (leader) ui.setLeaderText('Leader: ' + leader.username);
                    }
                }
